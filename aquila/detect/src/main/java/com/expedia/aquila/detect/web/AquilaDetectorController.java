 ...
 */
@RestController
public class AquilaDetectorController {
    
    @Autowired
    private AquilaDetectorService aquilaDetectorService;
    
    @RequestMapping(value = "/detect", method = RequestMethod.POST)
    public AquilaResponse classify(@RequestBody AquilaRequest request) {
        return aquilaDetectorService.classify(request);
    }
}

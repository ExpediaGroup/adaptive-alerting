...
public class S3PredictionModelRepo implements PredictionModelRepo {
    ...
    public S3PredictionModelRepo(Config config) {
        ...
        notNull(region, "region can't be null");
        notNull(bucketName, "bucketName can't be null");
        
        log.info("Initializing S3PredictionModelRepo: region={}, bucketName={}", region, bucketName);
    ...
    private String getObjectPath(UUID detectorUuid) {
        return detectorUuid.toString() + ".json";
    }
}

...
import static com.expedia.adaptivealerting.anomdetect.outlier.AnomalyLevel.MODEL_WARMUP;
import static com.expedia.adaptivealerting.anomdetect.outlier.AnomalyLevel.NORMAL;
 ...
 */
public final class IndividualsOutlierDetector implements Detector {
    ...
    public IndividualsOutlierDetector(UUID uuid, Params params) {

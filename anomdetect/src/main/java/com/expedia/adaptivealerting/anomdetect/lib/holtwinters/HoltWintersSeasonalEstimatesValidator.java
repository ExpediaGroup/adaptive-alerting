...
public class HoltWintersSeasonalEstimatesValidator {
    ...
    private void checkLength(double[] initSeasonalEstimates, int frequency) {
        isEqual(initSeasonalEstimates.length, frequency,
    ...
    private void checkSumOfEstimates(double[] initSeasonalEstimates, int frequency, SeasonalityType seasonalityType) {
        ...
        if (seasonalityType.equals(MULTIPLICATIVE)) {
    ...
    private static double[] distancesFromIdentity(double[] values, SeasonalityType seasonalityType, int frequency) {
        return seasonalityType.equals(MULTIPLICATIVE) ? eachMinusOne(values, frequency) : values;
    }

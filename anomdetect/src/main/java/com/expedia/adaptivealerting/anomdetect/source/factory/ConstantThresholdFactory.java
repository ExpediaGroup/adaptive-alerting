...
public class ConstantThresholdFactory implements DetectorFactory<ConstantThresholdDetector> {
    ...
    public ConstantThresholdDetector buildDetector() {
        ...
        val params = objectMapper.convertValue(paramsMap, ConstantThresholdParams.class);

...
public class CusumOutlierDetectorBuilder implements TypedDetectorBuilder<CusumOutlierDetector> {

    @Override
    public CusumOutlierDetector build(DetectorDocument document) {

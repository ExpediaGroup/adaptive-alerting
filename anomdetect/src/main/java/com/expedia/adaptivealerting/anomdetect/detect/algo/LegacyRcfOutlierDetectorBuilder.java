...
/**
 * @deprecated RCF is an external detector type, and shouldn't be part of AA proper. At least not the AWS version.
 */
@Deprecated
public class LegacyRcfOutlierDetectorBuilder implements TypedDetectorBuilder<Detector> {

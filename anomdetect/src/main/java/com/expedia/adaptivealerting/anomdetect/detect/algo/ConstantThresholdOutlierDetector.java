...
import com.expedia.adaptivealerting.anomdetect.detect.AbstractOutlierDetector;
import com.expedia.adaptivealerting.anomdetect.detect.AnomalyClassifier;
...
public final class ConstantThresholdOutlierDetector extends AbstractOutlierDetector {
    ...
    @Getter
    private final ConstantThresholdOutlierDetectorParams params;

    private final AnomalyClassifier classifier;

    public ConstantThresholdOutlierDetector(UUID uuid, ConstantThresholdOutlierDetectorParams params) {
        super(uuid);

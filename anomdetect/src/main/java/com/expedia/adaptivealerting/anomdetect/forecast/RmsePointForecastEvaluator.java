 ...
 */
public class RmsePointForecastEvaluator implements PointForecastEvaluator {
     ...
     */
    public RmsePointForecastEvaluator() {
        reset();
    }
    ...
    @Override
    public PointForecastEvaluation evaluate() {
        double rmse = Math.sqrt(resSumSquares / n);
        return new PointForecastEvaluation("rmse", rmse);
    }

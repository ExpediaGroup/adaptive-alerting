...
/**
 * We currently need this in addition to {@link CusumOutlierDetector.Params}
...
public class CusumParams {
    ...
    public CusumOutlierDetector.Params toNewParams() {
        return new CusumOutlierDetector.Params()
                .setType(type)

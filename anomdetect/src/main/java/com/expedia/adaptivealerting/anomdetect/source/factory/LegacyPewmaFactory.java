...
public class LegacyPewmaFactory implements DetectorFactory<ForecastingDetector> {
    ...
    public ForecastingDetector buildDetector() {
        ...
        val legacyParams = objectMapper.convertValue(paramsMap, LegacyPewmaParams.class);

...
public class IndividualsOutlierDetectorTest {
    ...
    public void testEvaluate() {
        ...
        val params = new IndividualsOutlierDetector.Params()
                .setInitValue(observed0)
                .setWarmUpPeriod(WARMUP_PERIOD);
        val detector = new IndividualsOutlierDetector(detectorUuid, params);

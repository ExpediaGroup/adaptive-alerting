...
import static com.expedia.adaptivealerting.anomdetect.lib.holtwinters.HoltWintersAustouristsTestHelper.*;
...
public class HoltWintersOnlineComponentsTest {
    ...
    public void testConstructorNoInitSeasonalsMultiplicative() {
        final HoltWintersParams params = buildAustouristsParams(MULTIPLICATIVE);
        HoltWintersOnlineComponents subject = new HoltWintersOnlineComponents(params);
    ...
    public void testConstructorNoInitSeasonalsAdditive() {
        final HoltWintersParams params = buildAustouristsParams(ADDITIVE);
        HoltWintersOnlineComponents subject = new HoltWintersOnlineComponents(params);

...
import com.expedia.adaptivealerting.anomdetect.detect.algo.EdmxBreakoutDetectorHyperparams;
...
public final class EdmxBreakoutDetectorTest {
    ...
    public void testDetect_whiteNoiseWithBreakout() throws Exception {
        val hyperparams = new EdmxBreakoutDetectorHyperparams()
                .setBufferSize(20)
                .setDelta(6)
                .setNumPerms(199)
                .setAlpha(0.01);
        val detectorUnderTest = new EdmxBreakoutDetector(UUID.randomUUID(), hyperparams);

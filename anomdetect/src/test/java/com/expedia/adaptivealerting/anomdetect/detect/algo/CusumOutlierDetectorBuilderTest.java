...
public class CusumOutlierDetectorBuilderTest extends AbstractDetectorBuilderTest {
    private CusumOutlierDetectorBuilder builderUnderTest;

    @Before
    public void setUp() {
        this.builderUnderTest = new CusumOutlierDetectorBuilder();
    }
}

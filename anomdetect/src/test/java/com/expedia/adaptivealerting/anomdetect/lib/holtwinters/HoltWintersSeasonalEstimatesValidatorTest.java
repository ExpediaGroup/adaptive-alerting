 ...
 */
package com.expedia.adaptivealerting.anomdetect.lib.holtwinters;

import com.expedia.adaptivealerting.anomdetect.lib.holtwinters.HoltWintersSeasonalEstimatesValidator;
...
public class HoltWintersSeasonalEstimatesValidatorTest {
    ...
    public void testEmptySeasonalEstimatesIsValid() {
        subject.validate(new double[]{}, DUMMY_FREQUENCY, MULTIPLICATIVE);
    }

    @Test
    public void testValidMultiplicativeSeasonalEstimatesIsValid() {
        subject.validate(VALID_MULTIPLICATIVE_SEASONAL_COMPONENT, DUMMY_FREQUENCY, MULTIPLICATIVE);
    }

    @Test
    public void testValidAdditiveSeasonalEstimatesIsValid() {
        subject.validate(VALID_ADDITIVE_SEASONAL_COMPONENT, DUMMY_FREQUENCY, ADDITIVE);
    }
    ...
    public void testInvalidSeasonalEstimatesLength() {
        ...
        subject.validate(INSUFFICIENT_SEASONAL_ESTIMATES, DUMMY_FREQUENCY, MULTIPLICATIVE);
    }
    ...
    public void testInvalidInitSeasonalEstimateAdditive() {
        ...
        subject.validate(INVALID_ADDITIVE_SEASONAL_COMPONENT, DUMMY_FREQUENCY, ADDITIVE);
    }
    ...
    public void testInvalidInitSeasonalEstimateMultiplicative() {
        ...
        subject.validate(INVALID_MULTIPLICATIVE_SEASONAL_COMPONENT, DUMMY_FREQUENCY, MULTIPLICATIVE);
    }

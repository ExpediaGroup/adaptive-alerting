...
public class CusumOutlierDetectorTest {
    ...
    private static List<CusumOutlierDetectorTestRow> data;
    ...
    public void testClassify_leftTailed() {
        ...
        val params = new CusumOutlierDetectorParams()
                .setType(anomalyType)
        ...
        val testRows = new CusumOutlierDetectorTestRow[]{
                new CusumOutlierDetectorTestRow(1020.0, AnomalyLevel.NORMAL.name()),
                new CusumOutlierDetectorTestRow(994.0, AnomalyLevel.WEAK.name()),
                new CusumOutlierDetectorTestRow(990.0, AnomalyLevel.STRONG.name()),
        };
    ...
    public void testClassify_twoTailed() {
        ...
        val testRows = new CusumOutlierDetectorTestRow[]{
                new CusumOutlierDetectorTestRow(1000.0, AnomalyLevel.NORMAL.name()),
                new CusumOutlierDetectorTestRow(1020.0, AnomalyLevel.STRONG.name()),
                new CusumOutlierDetectorTestRow(994.0, AnomalyLevel.NORMAL.name()),
                new CusumOutlierDetectorTestRow(960.0, AnomalyLevel.WEAK.name()),
        };

        testClassify(params, anomalyType, testRows);
    }

    private void testClassify(CusumOutlierDetectorParams params, AnomalyType anomalyType, CusumOutlierDetectorTestRow[] testRows) {
        val detector = new CusumOutlierDetector(detectorUuid, params);
    ...
    private static void readDataFromCsv() {
        ...
        data = new CsvToBeanBuilder<CusumOutlierDetectorTestRow>(new InputStreamReader(is))
                .withType(CusumOutlierDetectorTestRow.class)
                .build()
                .parse();
    }

...
public final class TestObjectMother {
    ...
    public static MappedMetricData mappedMetricData(MetricData metricData, String consumerId, UUID uuid) {
        return new MappedMetricData(metricData, consumerId, uuid);
    }

...
public class CreateDetectorConsumerInfoMappingRequestTest {
    ...
    private void initTestObjects() {
        ...
        this.detectorConsumerInfo = new DetectorConsumerInfo("cid", UUID.randomUUID());
        this.user = new User("yoda");
    }

    @Test
    public void testEquals() {
        val requestUnderTest = new CreateDetectorMappingRequest(expression, detectorConsumerInfo, user);
        assertNotEquals(requestUnderTest, null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testValidate_nullUser() {
        val requestUnderTest = new CreateDetectorMappingRequest(expression, detectorConsumerInfo, null);
    ...
    public void testValidate_nullExpression() {
        val requestUnderTest = new CreateDetectorMappingRequest(null, detectorConsumerInfo, user);
        requestUnderTest.validate();
    }
}

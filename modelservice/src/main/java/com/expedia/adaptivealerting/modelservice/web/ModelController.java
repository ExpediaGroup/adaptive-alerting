...
public class ModelController {
    ...
    @PutMapping(value = "/models/{uuid}/hyperparams", produces = MediaType.APPLICATION_JSON_VALUE)
    public String addHyperparams(@PathVariable String uuid, @RequestBody Hyperparams hyperparams) {
        modelService.addHyperparams(uuid, hyperparams);
        return "Model params saved successfully";
    }

    @ApiOperation(value = "Mark model to rebuild")
    @PutMapping(value = "/models/{uuid}/rebuild", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = "/models/{uuid}/thresholds", produces = MediaType.APPLICATION_JSON_VALUE)

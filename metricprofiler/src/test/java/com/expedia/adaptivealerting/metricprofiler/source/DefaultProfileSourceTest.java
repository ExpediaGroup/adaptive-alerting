...
import static com.expedia.adaptivealerting.metricprofiler.source.DefaultProfileSource.FIND_DOCUMENT_PATH;
...
public class DefaultProfileSourceTest {
    ...
    private DefaultProfileSource classUnderTest;
    ...
    public void setUp() throws Exception {
        ...
        this.classUnderTest = new DefaultProfileSource(httpClient, objectMapper, BASE_URI);
        initTestObjects();
        initDependencies();
    }
    ...
    public void testFindProfilingDocument_http_io_exception() {
        ...
        classUnderTest.profileExists(metricDefinition_cantRead);
    }
    ...
    public void testFindProfilingDocument_http_io_exception_1() {
        ...
        classUnderTest.profileExists(metricDefinition_invalidContent);
    }
